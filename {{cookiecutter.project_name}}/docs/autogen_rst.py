...
def index_template(package_name: str, doc_references: Optional[list[str]] = None, text_prefix=""):
    ...
    if title == "{{cookiecutter.project_name}}":
        title = "{{cookiecutter.project_name}} API Reference"
...
_SUBTITLE = (
    "\n Here is the autogenerated documentation of the {{cookiecutter.project_name}} API. \n \n "
